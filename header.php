...
<header>
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="Result/index.php"><i class="fa fa-clone" aria-hidden="true"></i> RESULT</a></li>
            <li><a href="prev paper/index.php"><i class="fa fa-sticky-note" aria-hidden="true"></i> PREV PAPER</a></li>
            <li><a href="online-examination-systen-in-php-master/index.php"><i class="fa fa-clone" aria-hidden="true"></i>ONLINE TEST</a></li>
